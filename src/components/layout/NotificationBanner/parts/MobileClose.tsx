  ...
  return (
    <button
      className={`
        ...
        hover:bg-solid-gray-50 hover:outline-solid hover:outline-1
        focus-visible:bg-yellow-300 focus-visible:outline-solid focus-visible:outline-4 focus-visible:outline-offset-[calc(2/16*1rem)] focus-visible:outline-black focus-visible:ring-[calc(2/16*1rem)] focus-visible:ring-yellow-300
        ${className ?? ""}
      `}
      type="button"
      {...rest}
